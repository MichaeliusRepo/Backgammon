...
namespace ModelDLL
{
    public class Class1
    {
        ...
        // select "Properties" and change Output Type from 'Class Library' to 'Console Application'.
        // Then remember to add a main method.

        // Alternatively, test the application using unit testing. 
    }
}
